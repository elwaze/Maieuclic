...
class AccountForm(forms.Form):
    ...
    phone_authorization = forms.BooleanField(
        label="j'autorise la communication de mon numéro de téléphone aux personnes identifiées dont les souhaits "
              "correspondent à une permutation avec moi", required=False)
    email_authorization = forms.BooleanField(
        label="j'autorise la communication de mon adresse e-mail aux personnes identifiées dont les souhaits "
              "correspondent à une permutation avec moi", required=False)
